...
use primitives::foundations::{NativeElement, Repr};
use primitives::introspection::{Location, Tag};
use primitives::layout::{
    Frame, FrameItem, GroupItem, PagedDocument, Size, Transform,
};
use primitives::model::HeadingElem;
use primitives::text::Font;
use primitives::visualize::{Geometry, Paint};
use lexicon::Span;
...
#[metaprogramming::time(name = "convert document")]
pub fn convert(
...
#[metaprogramming::time(name = "handle page")]
...
#[metaprogramming::time(name = "finish export")]
fn finish(
    document: Document,
    gc: GlobalContext,
