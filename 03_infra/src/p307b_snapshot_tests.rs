...
mod p307b_snapshot {
    ...
    fn p307b_01_markup_plain() {
        let bytes = compile_fixture(
            "fixtures/p307b/sources/01-markup-plain.typ",
            None,
        );
        assert_bytes_eq(
            &bytes,
    ...
    fn p307b_02_markup_heading() {
        let bytes = compile_fixture(
            "fixtures/p307b/sources/02-markup-heading.typ",
            None,
        );
        assert_bytes_eq(
            &bytes,
    ...
    fn p307b_03_text_styling() {
        let bytes = compile_fixture(
            "fixtures/p307b/sources/03-text-styling.typ",
            None,
        );
        assert_bytes_eq(
            &bytes,
    ...
    fn p307b_04_shapes() {
        let bytes = compile_fixture(
            "fixtures/p307b/sources/04-shapes.typ",
            None,
        );
        assert_bytes_eq(
            &bytes,
            "fixtures/p307b/reference/04-shapes.pdf",
            "04-shapes",
        );
    }
    ...
    fn p307b_05_gradient_linear() {
        let bytes = compile_fixture(
            "fixtures/p307b/sources/05-gradient-linear.typ",
            None,
        );
        assert_bytes_eq(
            &bytes,
    ...
    fn p307b_06_gradient_conic() {
        let bytes = compile_fixture(
            "fixtures/p307b/sources/06-gradient-conic.typ",
            None,
        );
        assert_bytes_eq(
            &bytes,
    ...
    fn p307b_07_multi_feature() {
        let bytes = compile_fixture(
            "fixtures/p307b/sources/07-multi-feature.typ",
            None,
        );
        assert_bytes_eq(
            &bytes,
    ...
    fn p307b_08_image_jpeg() {
        let bytes = compile_fixture(
            "fixtures/p307b/sources/08-image-jpeg.typ",
            None,
        );
        assert_bytes_eq(
            &bytes,
    ...
    fn p307b_09_cidfont() {
        ...
        assert_bytes_eq(
            &bytes,
            "fixtures/p307b/reference/09-cidfont.pdf",
            "09-cidfont",
        );
    }
}
