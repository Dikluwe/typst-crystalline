...
| 6 | Sealing point identificado e implementado: `Layouter::finish` produz sealed sub-stores reproduzivelmente | **CUMPRIDA** | `Layouter::finish` em `01_core/src/engine/layout/mod.rs:1187-1189` produz `extracted_positions` 1× por iteração; padrão `from_runtime` consolidado |
