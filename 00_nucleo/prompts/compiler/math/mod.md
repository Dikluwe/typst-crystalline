...
Hash do Código: b15d889f

**Camada**: L1
**Ficheiro alvo**: `01_core/src/compiler/math/mod.rs`
...
// Importabilidade
use crate::compiler::math::layout::MathLayouter;  // compila
use crate::compiler::math::symbols::ident_to_unicode;  // compila

// Ausência de dependências externas
grep "ttf_parser" 01_core/src/compiler/math/ = vazio
