...
**Ficheiros adjacentes**: `01_core/src/compiler/layout/mod.rs`, `03_infra/src/pipeline.rs`  
...
`flush_pending_footnote_bodies` em `01_core/src/compiler/layout/cursor.rs` calcula `top_safe` a partir dos `current_items` já posicionados. Isso é insuficiente quando:
...
Em `01_core/src/compiler/layout/cursor.rs`:
...
Em `01_core/src/compiler/layout/mod.rs`:
