...
- `01_core/src/compiler/introspect/extract_payload.rs` — função + 5 tests unitários.
- `01_core/src/compiler/introspect/mod.rs` (criado neste passo) — re-export `extract_payload`.
