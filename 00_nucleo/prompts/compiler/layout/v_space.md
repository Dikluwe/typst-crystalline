...
**Camada:** L1 render
**Ficheiro alvo:** `01_core/src/compiler/layout/v_space.rs`
**ADRs:** ADR-0107, ADR-0108, ADR-0109, ADR-0129

## Medição e contrato

Aplicar espaço vertical no fluxo, fechando linha quando necessário e respeitando regiões, paginação e colapso vigente.
