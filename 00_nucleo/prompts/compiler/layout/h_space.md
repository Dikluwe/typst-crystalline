...
**Camada:** L1 render
**Ficheiro alvo:** `01_core/src/compiler/layout/h_space.rs`
**ADRs:** ADR-0107, ADR-0108, ADR-0109, ADR-0129

## Medição e contrato

Aplicar espaço horizontal Length/Fraction no fluxo inline, expandindo frações somente sob largura finita.
