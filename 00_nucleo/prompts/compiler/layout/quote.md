...
**Camada:** L1 render
**Ficheiro alvo:** `01_core/src/compiler/layout/quote.rs`
**ADRs:** ADR-0107, ADR-0108, ADR-0109, ADR-0129

## Medição e contrato

Renderizar quote inline/bloco com aspas dependentes de idioma, attribution e fluxo do body.
