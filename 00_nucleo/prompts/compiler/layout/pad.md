...
**Camada:** L1 render
**Ficheiro alvo:** `01_core/src/compiler/layout/pad.rs`
**ADRs:** ADR-0107, ADR-0108, ADR-0109, ADR-0129

## Medição e contrato

Aplicar padding por lados ao body, reduzir região disponível e recompor itens no frame pai sem dupla origem.
