...
**Camada:** L1 render
**Ficheiro alvo:** `01_core/src/compiler/layout/hide.rs`
**ADRs:** ADR-0107, ADR-0108, ADR-0109, ADR-0129

## Medição e contrato

Consumir Hide sem emissão visual, preservando somente os efeitos semânticos já definidos pelo pipeline.
