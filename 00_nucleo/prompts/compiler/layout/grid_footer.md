# Prompt L0 — `grid_footer`
Hash do Código: ed19209d
...
**Camada:** L1 render
**Ficheiro alvo:** `01_core/src/compiler/layout/grid_footer.rs`
**ADRs:** ADR-0107, ADR-0108, ADR-0109, ADR-0129

## Medição e contrato

Delegar o corpo de GridFooter preservando sua posição como row-group decidida pelo owner de grid.
