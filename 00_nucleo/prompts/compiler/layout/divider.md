...
**Camada:** L1 render
**Ficheiro alvo:** `01_core/src/compiler/layout/divider.rs`
**ADRs:** ADR-0107, ADR-0108, ADR-0109, ADR-0129

## Medição e contrato

Emitir divisor no eixo e extensão pedidos, resolvendo stroke e avanço sem vazar estado de linha.
