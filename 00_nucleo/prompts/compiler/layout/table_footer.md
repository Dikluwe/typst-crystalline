# Prompt L0 — `table_footer`
Hash do Código: 6eceac77
...
**Camada:** L1 render
**Ficheiro alvo:** `01_core/src/compiler/layout/table_footer.rs`
**ADRs:** ADR-0107, ADR-0108, ADR-0109, ADR-0129

## Medição e contrato

Delegar o corpo de TableFooter preservando a semântica de row-group do owner de table/grid.
