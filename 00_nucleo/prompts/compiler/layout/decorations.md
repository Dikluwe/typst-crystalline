# Prompt L0 — `decorations`
Hash do Código: 6fe5abd1
...
**Camada:** L1 render
**Ficheiro alvo:** `01_core/src/compiler/layout/decorations.rs`
**ADRs:** ADR-0107, ADR-0108, ADR-0109, ADR-0129

## Medição e contrato

Emitir underline, strike e overline por segmentos visuais, incluindo wrap e subframes, com stroke explícito ou fill herdado.
