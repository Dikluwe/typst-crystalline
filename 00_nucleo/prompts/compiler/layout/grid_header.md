# Prompt L0 — `grid_header`
Hash do Código: 0b509432
...
**Camada:** L1 render
**Ficheiro alvo:** `01_core/src/compiler/layout/grid_header.rs`
**ADRs:** ADR-0107, ADR-0108, ADR-0109, ADR-0129

## Medição e contrato

Delegar o corpo de GridHeader preservando sua posição como row-group decidida pelo owner de grid.
