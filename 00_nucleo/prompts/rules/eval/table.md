...
**Camada**: L1 · **Alvo**: `01_core/src/rules/eval/rules.rs` (arm `target == "table"`) e `01_core/src/rules/stdlib/structural.rs`
...
Quando o eval encontra `table.header`, resolve `field = "header"` no namespace anexado a `table` e devolve o `Value::Func` correspondente. Ver `00_nucleo/prompts/rules/eval/field-access.md` §5.
