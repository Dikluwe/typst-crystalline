...
Hash do Código: `3a8202e4`

**Camada**: L1 (com wiring de warnings em L3/L4)  
**Ficheiros alvo**: `01_core/src/rules/layout/cursor.rs`, `01_core/src/rules/layout/columns.rs`, `01_core/src/entities/layout_types.rs`  
**Ficheiros adjacentes**: `01_core/src/rules/layout/mod.rs`, `03_infra/src/pipeline.rs`  
...
`flush_pending_footnote_bodies` em `01_core/src/rules/layout/cursor.rs` calcula `top_safe` a partir dos `current_items` já posicionados. Isso é insuficiente quando:
