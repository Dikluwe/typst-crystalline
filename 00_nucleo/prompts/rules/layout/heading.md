# Prompt L0 — `rules/layout/heading`
Hash do Código: 763aac55

**Camada**: L1 · **Alvo**: `01_core/src/rules/layout/heading.rs`
...
- `01_core/src/rules/layout/heading.rs` — free function `layout` + tests em `01_core/src/rules/layout/tests.rs`.
