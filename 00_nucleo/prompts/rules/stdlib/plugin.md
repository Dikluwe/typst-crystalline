...
existentes — **nenhuma alteração ao import** (ver `prompts/rules/import.md` e
`01_core/src/rules/eval/modules.rs:167-219`, eval.md §P683):
...
Os testes vivem em `01_core/src/rules/stdlib/plugin.rs` (unidade) e em
