...
Hash do Código: 3feb7aaa

**Camada**: L1
**Ficheiro alvo**: `01_core/src/engine/math/mod.rs`
...
// Importabilidade
use crate::engine::math::layout::MathLayouter;  // compila
use crate::engine::math::symbols::ident_to_unicode;  // compila

// Ausência de dependências externas
grep "ttf_parser" 01_core/src/engine/math/ = vazio
