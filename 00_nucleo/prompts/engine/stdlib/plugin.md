...
(`01_core/src/engine/eval/mod.rs:1559`); field access em `Func` sem
...
`Span::detached()` (`01_core/src/engine/stdlib/plugin.rs:25-27`) e três
`Span::detached()` em `call_plugin`
(`01_core/src/engine/eval/closures.rs:177,188,201`).
...
(`01_core/src/engine/stdlib/plugin.rs`, `01_core/src/contracts/plugin_host.rs`,
