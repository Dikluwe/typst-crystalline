...
- `01_core/src/engine/introspect/fixpoint.rs` — `MAX_FIXPOINT_ITERATIONS` const + `FixpointError` enum + `run_fixpoint` fn + 4 tests.
- Re-export em `01_core/src/engine/introspect.rs` (`pub mod fixpoint`).
