...
Hash do Código: 6099729c

**Camada**: L1
**Ficheiro alvo**: `01_core/src/engine/introspect/from_tags.rs`
...
- `01_core/src/engine/introspect/from_tags.rs` — função + tests.
- `01_core/src/engine/introspect.rs` — adicionar `pub mod from_tags;` em paralelo a `pub mod extract_payload;` e `pub mod locatable;`.
