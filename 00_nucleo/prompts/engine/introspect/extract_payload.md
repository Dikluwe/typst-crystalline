...
Hash do Código: c0324ebe

**Camada**: L1
**Ficheiro alvo**: `01_core/src/engine/introspect/extract_payload.rs`
...
- `01_core/src/engine/introspect/extract_payload.rs` — função + 5 tests unitários.
- `01_core/src/engine/introspect/mod.rs` (criado neste passo) — re-export `extract_payload`.
