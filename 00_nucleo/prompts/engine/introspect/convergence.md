...
Hash do Código: b4ed009a

**Camada**: L1
**Ficheiro alvo**: `01_core/src/engine/introspect/convergence.rs`
...
- `01_core/src/engine/introspect/convergence.rs` — função + 5 tests.
- Re-export em `01_core/src/engine/introspect.rs` (`pub mod convergence`).
