...
**Camada**: L1
**Ficheiros**:
  - `01_core/src/engine/parse.rs` — `parse()`, `parse_code()`, `parse_math()`, `Parser`
  - `01_core/src/engine/lexer/mod.rs` — `Lexer`
...
| Módulo | Uso |
|--------|-----|
| `crate::engine::lexer::scanner::Scanner` | Motor de travessia de string (ADR-0014) |
...
| `unscanny::Scanner` | `crate::engine::lexer::scanner::Scanner` | 0014 |
