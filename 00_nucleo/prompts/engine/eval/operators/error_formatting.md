# Prompt L0 — `engine/eval/operators/error_formatting` — mensagens de fronteira
Hash do Código: 1fbd3cb6

**Camada**: L1
**Ficheiro alvo**: `01_core/src/engine/eval/operators/error_formatting.rs`
