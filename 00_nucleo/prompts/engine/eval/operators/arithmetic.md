# Prompt L0 — `engine/eval/operators/arithmetic` — aritmética, unários e lógica booleana
Hash do Código: 0b6b37b2

**Camada**: L1
**Ficheiro alvo**: `01_core/src/engine/eval/operators/arithmetic.rs`
