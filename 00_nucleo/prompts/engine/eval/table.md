...
**Camada**: L1 · **Alvo**: `01_core/src/engine/eval/rules.rs` (arm `target == "table"`) e `01_core/src/engine/stdlib/structural.rs`
...
a `figure`. Ver `00_nucleo/prompts/engine/layout/table.md` §P661.
