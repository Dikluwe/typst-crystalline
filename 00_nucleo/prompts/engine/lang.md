...
Hash do Código: 80848c27

## Módulo
`01_core/src/engine/lang/`
...
Hyphenation continua em `engine/layout/hyphenation.rs` — refactor
...
1. **Layouter** (`engine/layout/mod.rs`) em `Content::Quote { quotes:
...
- **Localização do módulo**: `rules/lang/quotes.rs` (módulo novo).
  Hyphenation permanece em `engine/layout/` por ora — refactor
  unificador adiado.
