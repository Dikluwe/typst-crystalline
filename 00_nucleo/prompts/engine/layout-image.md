# Prompt L0 — engine/layout/image — `Content::Image` como bloco com ancoramento vertical

Hash do Código: b8ae3f7e

**Camada**: L1 · **Alvo**: `01_core/src/engine/layout/image.rs`  
**ADRs**: ADR-0107 (paridade linguagem), ADR-0108 (anti-deriva), ADR-0109 (atomização forma B)  
**Prompts relacionados**: `entities/elements/image.md`, `engine/layout/shape_block_behaviour.md`
