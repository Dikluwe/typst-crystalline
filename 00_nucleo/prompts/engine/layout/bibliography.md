# Prompt L0 — `engine/layout/bibliography` — Layout de Bibliography e Cite (fallback numérico)
Hash do Código: 59b9fd4e

**Camada**: L1
**Ficheiros alvo**: `01_core/src/engine/layout/bibliography.rs`, `01_core/src/engine/layout/cite.rs`
...
## `engine/layout/cite.rs` — P472 ibid.
...
## `engine/layout/cite.rs` — P468 CitationStyle::Numeric
...
## `engine/layout/mod.rs` — `format_bib_entry_body`
