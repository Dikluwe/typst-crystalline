# Prompt L0 — `engine/layout/table` — Layout de `Table`
Hash do Código: 2a323df3

**Camada**: L1 · **Alvo**: `01_core/src/engine/layout/table.rs`
**Prompt pai**: `00_nucleo/prompts/engine/layout.md`
...
4. Delegar o corpo da table a `layout_grid` (P157A/P224), preservando
   ...
   `grid.header`/`grid.footer` (P772i, ver `00_nucleo/prompts/engine/layout.md`
