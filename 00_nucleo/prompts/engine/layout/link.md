# Prompt L0 — `engine/layout/link` — Layout de `Content::Link`
Hash do Código: 623f3e79

**Camada**: L1 · **Alvo**: `01_core/src/engine/layout/link.rs`
...
- `engine/layout/link.rs` — free function `layout_link(layouter, &LinkElem)` que
