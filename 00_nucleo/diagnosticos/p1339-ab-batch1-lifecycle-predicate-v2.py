"""Non-vacuous aggregate checker; only judges observations of the actual product."""
...
def check(case,observed):
    ...
    for c in by['CandidateBuilt']:
        ...
        for v in validations:
            ...
            require([r['request_id'] for r in v['replayed_requests']]==expected_ids,'every actual registered request replayed in original order')
