...
**Actualizado em:** 2026-07-07 (Passos 602, 604, 605)  
...
| `bookmarked`/`outlined` em `heading()` | P604/P605 | **Fechado em P605** — o campo interno `HeadingElem::outlined` existia mas não era exposto. `heading()` agora aceita `outlined: bool` e `bookmarked: bool` (sinónimo); `false` exclui o heading de `/Outlines`. |
