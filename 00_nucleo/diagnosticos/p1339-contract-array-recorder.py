...
def run(argv):
    ...
    try:
        ...
        return dict(argv=argv, stdin='', stdout=str(e.stdout or ''), stderr=str(e.stderr or ''), exit=None, timeout_seconds=30, utc_start=start, utc_end=now())
...
def main():
    ...
    inputs=D/'p1339-contract-array-inputs-r2.json'; data=json.loads(inputs.read_text())
