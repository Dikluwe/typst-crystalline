...
for name in ['p1330-ab-tests.rs','p1330-ab-p1328-successor.rs','p1329-ab-tests-r1.rs']:
...
print(json.dumps(dict(pass_gate=True,hash_a=a,hash_b=b,manifest_sha256=r.sha(D/'p1330-manifest-r2.json')),indent=2))
