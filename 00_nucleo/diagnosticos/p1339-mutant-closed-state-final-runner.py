"""Frozen phase-F runner. Actual test binaries only; no preseal runtime credit.
...
GROUPS={
 ...
 'P1339_LIFECYCLE':('p1339-ab-batch1-retention-lifecycle-typed-r2.json','case_id',144),
}
...
def main():
 ...
 lifecycle=load_module('p1339_frozen_lifecycle','p1339-ab-batch1-lifecycle-predicate-v2.py')
 opaque=load_module('p1339_frozen_opaque','p1339-ab-batch1-opaque-predicate.py')
 cases={c['id']:c for c in read(D/'p1339-ab-batch1-retention-lifecycle-typed-r2.json')['cases']}
