...
FROZEN = ROOT / "00_nucleo/diagnosticos/p1329-ab-cli-expected-r2.json"
...
def main():
    ...
    if args.freeze_from:
        ...
        save(args.output, {"frozen_utc": datetime.datetime.now(datetime.timezone.utc).isoformat(),
                           ...
                           "manifest_sha256": digest(ROOT / "00_nucleo/diagnosticos/p1329-manifest-r2.json"),
        ...
        return
    assert normhash() == "07f83fc24dc13837f54a25f0bec6be20ff495e1f679c4975bec3f1fb583ef5ae"
