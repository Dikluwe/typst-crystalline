"""Independent complete C matrix r2 after last focal, one budgeted run, gated by focal acceptance.
...
PINS = {
 'p1339-verifier-full-c-r1.py':'f2efae2c74c2bc84ccdc2f82d9d156a09581fe1b1ee3a740d805e51e08f821d7',
 'p1339-ab-batch2-manifest.json':'b8a80d79122785bb089ff65698ce5e0225cc0ed2e114db149ccdde7ef7cfb465',
 'p1339-verifier-batch2-manifest-acceptance-r1.json':'0d4f3c619d6d648f54d70e54d8ecd9a5314fa00c56c22c4632789c673e8089f3',
...
def main():
 ...
 assert acceptance['verdict']=='PASS_FOCAL_BATCH2'
 focal=read(checked(acceptance['raw']));derived=read(checked(acceptance['derived']))
 transport=module('p1339_frozen_transport','p1339-ab-executor-v4.py');predicate=module('p1339_frozen_predicate','p1339-ab-batch2-public-predicate.py')
 plan=read(D/'p1339-ab-batch2-cli-plan.json');inventories=validate_inputs(plan,transport);before=state()
