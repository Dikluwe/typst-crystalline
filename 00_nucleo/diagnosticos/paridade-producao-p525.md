...
1. **Export PDF com variações visuais:** o subsetter já preserva `fvar`/`gvar`, mas o `/W` do CIDFont usa instância default. Futuro passo deve instanciar a VF para o peso/estilo usado ou emitir coordenadas de eixo (PDF 2.0).
