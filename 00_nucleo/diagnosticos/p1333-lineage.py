...
m=json.loads((D/'p1333-manifest.json').read_text())
...
print(json.dumps(dict(pass_gate=True,hash_a=a,hash_b=b,manifest_sha256=r.sha(D/'p1333-manifest.json')),indent=2))
