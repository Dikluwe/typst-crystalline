...
events = [
    {'id': 'ledger-r1-publication-abort', 'product_processes': 0, 'utc': None, 'reason_code': 'apply_patch_argv_size_limit', 'wall_seconds': 0.158091267, 'detail': 'Metadata-only ledger generator r1 could not launch apply_patch because the patch exceeded argv limits. No ledger or semantic output was written; r2 passes the same publication through stdin. Not a product calibration.'},
...
subprocess.run(['apply_patch'], input=patch, check=True, cwd=ROOT, capture_output=True, text=True)
