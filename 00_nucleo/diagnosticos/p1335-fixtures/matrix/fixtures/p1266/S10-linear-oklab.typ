...
#let g = gradient.linear((red.transparentize(99%), 0%), (rgb(46, 204, 64).transparentize(99%), 16.6666666666667%), (blue.transparentize(99%), 33.3333333333333%), (yellow.transparentize(99%), 50%), (red.transparentize(99%), 50.0001%), (rgb(46, 204, 64).transparentize(99%), 66.6667333333333%), (blue.transparentize(99%), 83.3333666666667%), (yellow.transparentize(99%), 100%), space: color.oklab, angle: 359.9999deg)
