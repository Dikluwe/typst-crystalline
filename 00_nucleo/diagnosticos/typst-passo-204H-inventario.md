...
| 2 | **P204C materializado**: Layouter ganha lifetime parameter; field `introspector` é `Tracked<'a, dyn Introspector + 'a>`. Consumers migrados (10 sites Layouter). | ✅ **CUMPRIDA** | `01_core/src/engine/layout/mod.rs:67` (struct Layouter com `'a` lifetime + Tracked introspector field). 2 sentinelas P204C. Relatório `typst-passo-204C-relatorio.md`. |
