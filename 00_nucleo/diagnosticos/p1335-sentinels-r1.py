...
def freeze():
    ...
    names=['p1335-sentinels-cases.json','p1335-sentinels-r1.py','p1335-record.py','p1335-matrix.py','p1309-matrix.py','p1309-record-r2.py','p1307-r4-oracle.py','p1322-sentinels-cases.json','p1334-ab-cli-baseline.json','p1334-ab-cross-baseline.json','p1335-classification-required-sentinels.json']
