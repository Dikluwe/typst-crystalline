# Diagnóstico Passo 1038 — Medição de Cobertura de Linha/Função/Região nos 5 Nós Fatiados e Mensagens de Erro

> **Nota Importante (Passo 1039):** A tentativa de MC/DC real via `-Z coverage-options=mcdc` falhou (nightly `1.99.0-nightly` só aceita `block | branch | condition`). Os números na tabela abaixo medem **cobertura de linha/função/região** (agregados de toda a suíte de testes do workspace), métrica mais fraca que MC/DC. Ver relatório do Passo 1039 para a análise de viabilidade do `gnatcov`.
...
## 1. Esclarecimento Sobre Flags de Instrumentação no Rust Nightly
...
Isso confirma empiricamente que no compilador Rust nightly atual (`1.99.0-nightly`), as opções válidas para `-Z coverage-options` são `block`, `branch` e `condition`.
...
## 2. Fase A — Cobertura de Linha/Função/Região nos 5 Nós Fatiados (Workspace Completo)
...
| Família / Módulo | Cobertura de Linhas (Cover / Total) | Cobertura de Funções (Cover / Total) | Cobertura de Regiões (% Executado) | Suspeita de Constant Folding (LLVM #109944) |
| :--- | :---: | :---: | :---: | :--- |
| **1. `compiler/eval/bindings/`** (P1013)<br>- `method_dispatch.rs`<br>- `binding.rs`<br>- `field_access.rs`<br>- `access.rs`<br>- `value_methods.rs` | <br>**87.29%** (206/236)<br>**84.81%** (229/270)<br>**71.95%** (277/385)<br>**90.70%** (117/129)<br>**62.98%** (313/497) | <br>**100.00%** (13/13)<br>**76.92%** (10/13)<br>**68.42%** (13/19)<br>**100.00%** (7/7)<br>**73.68%** (14/19) | <br>87.92%<br>81.56%<br>76.13%<br>88.14%<br>66.39% | **Não aplicável** — esta medição é cobertura de linha/região/função, não MC/DC (o bug #109944 é específico para pares de independência de condições MC/DC). |
| **2. `compiler/stdlib/structural/`** (P1014/P1023)<br>- `mod.rs`<br>- `heading.rs`<br>- `markup.rs`<br>- `table_grid.rs`<br>- `math.rs` | <br>**89.82%** (556/619)<br>**56.14%** (64/114)<br>**32.43%** (36/111)<br>**75.98%** (370/487)<br>**74.02%** (208/281) | <br>**91.25%** (73/80)<br>**100.00%** (1/1)<br>**75.00%** (3/4)<br>**100.00%** (11/11)<br>**100.00%** (10/10) | <br>94.33%<br>65.84%<br>31.08%<br>76.47%<br>81.46% | **Não aplicável** — medição de linha/região, não MC/DC. |
| **3. `compiler/stdlib/text/`** (P1022)<br>- `lorem.rs`<br>- `smallcaps.rs`<br>- `smartquote.rs`<br>- `constructor.rs` | <br>**93.75%** (60/64)<br>**78.12%** (25/32)<br>**64.41%** (38/59)<br>**43.59%** (119/273) | <br>**100.00%** (3/3)<br>**100.00%** (1/1)<br>**100.00%** (1/1)<br>**63.64%** (7/11) | <br>95.51%<br>84.38%<br>72.41%<br>47.17% | **Não aplicável** — medição de linha/região, não MC/DC. |
| **4. `compiler/eval/operators/`** (P1002)<br>- `arithmetic.rs`<br>- `equality.rs`<br>- `ordering.rs`<br>- `error_formatting.rs` | <br>**79.48%** (306/385)<br>**71.19%** (42/59)<br>**69.07%** (67/97)<br>**72.84%** (59/81) | <br>**94.12%** (16/17)<br>**100.00%** (8/8)<br>**80.00%** (4/5)<br>**100.00%** (4/4) | <br>79.69%<br>71.05%<br>64.49%<br>78.85% | **Não aplicável** — medição de linha/região, não MC/DC. |
| **5. `compiler/stdlib/foundations/`** (P1032)<br>- `color.rs`<br>- `cast.rs`<br>- `query.rs`<br>- `str.rs` | <br>**67.49%** (272/403)<br>**59.24%** (282/476)<br>**72.59%** (143/197)<br>**66.67%** (112/168) | <br>**69.81%** (37/53)<br>**65.79%** (25/38)<br>**90.91%** (10/11)<br>**57.14%** (12/21) | <br>69.24%<br>66.53%<br>64.29%<br>68.66% | **Não aplicável** — medição de linha/região, não MC/DC. |

### Resposta à Pergunta Central da Fase A (Linha / Função / Região)
- **A suíte de testes existente do workspace já cobre entre 60% e 90%+ das linhas e funções nos 5 nós.**
- **Nós com menor cobertura de linhas a reforçar:** `text/constructor.rs` (43.59% linhas), `stdlib/structural/heading.rs` (56.14% linhas) e `foundations/cast.rs` (59.24% linhas).
