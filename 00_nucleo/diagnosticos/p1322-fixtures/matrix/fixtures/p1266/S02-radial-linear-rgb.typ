...
#let g = gradient.radial((rgb(38, 70, 83), 0%), (rgb(42, 157, 143), 50%), (rgb(233, 196, 106), 100%), space: color.linear-rgb, center: (50%, 50%), radius: 60%, focal-center: (50%, 50%), focal-radius: 0%)
