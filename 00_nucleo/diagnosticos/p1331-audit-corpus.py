...
new = json.loads((D/'p1331-ab-cli-expected.json').read_text())
...
r.save('historical-expectations',dict(at=r.now(),pass_gate=True,unchanged=324,
    changed=changed,new_observations=len(new_expected)-332,
    expected_sha256=r.sha(D/'p1331-ab-cli-expected.json'),
    previous_expected_sha256=r.sha(D/'p1330-ab-cli-expected.json'),
    baseline_sha256=r.sha(D/'p1331-ab-cli-baseline.json'),
    manifest_sha256=r.sha(D/'p1331-manifest.json')))
