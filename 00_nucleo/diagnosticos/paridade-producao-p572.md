...
**Data:** 2026-07-05  
**Scope:** `01_core/src/rules/layout/cursor.rs`, `01_core/src/rules/layout/mod.rs`, `01_core/src/rules/layout/text.rs`, `00_nucleo/diagnosticos/paridade-producao-p569.md`.
...
- Código L1 revertido para HEAD (`01_core/src/rules/layout/cursor.rs`, `mod.rs`, `text.rs`).
...
```bash
git checkout HEAD -- 01_core/src/rules/layout/cursor.rs 01_core/src/rules/layout/mod.rs 01_core/src/rules/layout/text.rs
```
...
| Ficheiro | Alteração |
|---|---|
| `01_core/src/rules/layout/cursor.rs` | Revertido para HEAD (removido `layout_space`). |
| `01_core/src/rules/layout/mod.rs` | Revertido para HEAD (removido `pending_space_width` e braço `Content::Space` alterado). |
| `01_core/src/rules/layout/text.rs` | Revertido para HEAD (volta a usar avanço directo de `cursor_x`). |
