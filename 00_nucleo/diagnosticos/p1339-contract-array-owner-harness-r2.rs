...
pub fn assert_array_owner(
    ...
    // Original four private-bridge vectors: exact argument/value spans distinct.
    for (id, name, occurrence_span, value_span, expected_span, message) in [
        ("ARR-U01-detached-positional", None, detached, Span::from_range(file, 122..123), aggregate, "unexpected argument"),
        ("ARR-U02-known-positional", None, positional_span, Span::from_range(file, 122..123), positional_span, "unexpected argument"),
        ("ARR-U03-detached-named", Some("other"), detached, Span::from_range(file, 122..123), aggregate, "unexpected argument: other"),
        ("ARR-U04-known-named", Some("other"), named_span, Span::from_range(file, 127..128), named_span, "unexpected argument: other"),
    ] {
        ...
        assert_error(&mut owner, &args, message, expected_span, id);
    }
