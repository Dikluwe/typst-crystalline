...
MANIFEST = D / "p1331-manifest.json"
FROZEN = D / "p1331-ab-cli-expected.json"
...
def main():
    ...
    assert digest(MANIFEST) == "837bb832ce13f0686a438f672c6fe001224738a15b1a369efcc6f7533b7db141"
