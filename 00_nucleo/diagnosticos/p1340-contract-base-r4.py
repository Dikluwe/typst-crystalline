"""R4 successor: actual feature origins; all other R3 obligations inherited."""
...
def check(case,observed):
    ...
    for x,y in [(start_by[k],finish_by[k]) for k in start_by]:
        ...
        require(isinstance(x['resources']['features'], list), 'R4-actual-feature-list')
        require(x['resources']['features'] in ([], ['html'], ['a11y-extras'], ['html', 'a11y-extras']), 'R4-real-supported-feature-set')
