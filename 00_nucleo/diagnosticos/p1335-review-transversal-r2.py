...
def run(focal):
    r=c.preflight();data=c.read('p1335-transversal-focal-r2.json' if focal else 'p1335-transversal-r2.json')
    frozen=c.read('p1335-transversal-freeze-r2.json');corpus=c.read('p1335-transversal-cases.json')
    r.require(data['freeze_sha256']==c.digest(D/'p1335-transversal-freeze-r2.json'),'TRANSVERSAL_FREEZE',focal)
