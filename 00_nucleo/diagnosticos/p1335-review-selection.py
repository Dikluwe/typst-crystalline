...
def main():
    r=c.preflight();selection=c.read('p1335-classification-selection.json');summary=c.read('p1335-classification-summary.json');lineage=c.read('p1335-classification-source-lineage.json')
    ...
    ledger=s.table('p1335-classification-owner-ledger.tsv');trans=s.table('p1335-classification-transitions.tsv');supp=c.read('p1335-sentinels-normal-r3.json')['rows']
