...
def main():
    ...
    parser.add_argument('mode', choices=['preflight', 'runtime', 'gates', 'supplement', 'transversal', 'transversal-r2', 'query-controls'])
    ...
    r, extra = {'preflight': lambda: (preflight(), {}), 'runtime': runtime_review,
                ...
                'transversal-r2': lambda: transversal_review('-r2'), 'query-controls':query_rejection_controls}[args.mode]()
