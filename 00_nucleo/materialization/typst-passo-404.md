# Passo 404 — Aritmética `Decimal`: `+`, `-`, `*`, `/` e comparações (S/M)
...
# 3. Confirmar infra de eval binário existente para Int/Float
grep -rn "BinaryOp::Add\|BinaryOp::Sub\|BinaryOp::Mul\|BinaryOp::Div\|BinaryOp::Eq\|BinaryOp::Lt" rules/eval/
# Esperado: match arms ou dispatch centralizado que trata Int/Float
...
Documentar resultado no commit: `Sonda P404: Decimal variant OK; eval binário infra OK (Int/Float); Decimal ausente em ops; rust_decimal OK.`
