...
use fusion::foundations::{Bytes, Datetime, Dict, IntoValue};
use fusion::syntax::{FileId, Lines, Source, VirtualPath};
        ...
        let library = {
            ...
            let features = process_args
                ...
                .map(|&feature| match feature {
                    Feature::Html => fusion::Feature::Html,
                    Feature::A11yExtras => fusion::Feature::A11yExtras,
                })
                .collect();
...
impl<T: Clone> SlotCell<T> {
    ...
    fn get_or_init(
        ...
        let fingerprint = timed!("hashing file", fusion::utils::hash128(&result));
