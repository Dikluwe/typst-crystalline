...
fn compile_and_export(
    ...
    match config.output_format {
        OutputFormat::Html => {
            let Warned { output, warnings } = fusion::compile::<HtmlDocument>(world);
        ...
        _ => {
            let Warned { output, warnings } = fusion::compile::<PagedDocument>(world);
...
fn export_pdf(document: &PagedDocument, config: &CompileConfig) -> SourceResult<()> {
    ...
    let buffer = pdf::pdf(document, &options)?;
    config
        .output
        .write(&buffer)
...
fn export_image_page(
    ...
    match fmt {
        ImageExportFormat::Png => {
            let pixmap = raster::render(page, config.ppi / 72.0);
            let buf = pixmap
                .encode_png()
...
impl ExportCache {
    ...
    pub fn is_cached(&self, i: usize, page: &Page) -> bool {
        let hash = fusion::utils::hash128(page);
...
impl From<PdfStandard> for pdf::PdfStandard {
    fn from(standard: PdfStandard) -> Self {
        match standard {
            PdfStandard::V_1_4 => pdf::PdfStandard::V_1_4,
            PdfStandard::V_1_5 => pdf::PdfStandard::V_1_5,
            PdfStandard::V_1_6 => pdf::PdfStandard::V_1_6,
            PdfStandard::V_1_7 => pdf::PdfStandard::V_1_7,
            PdfStandard::V_2_0 => pdf::PdfStandard::V_2_0,
            PdfStandard::A_1b => pdf::PdfStandard::A_1b,
            PdfStandard::A_1a => pdf::PdfStandard::A_1a,
            PdfStandard::A_2b => pdf::PdfStandard::A_2b,
            PdfStandard::A_2u => pdf::PdfStandard::A_2u,
            PdfStandard::A_2a => pdf::PdfStandard::A_2a,
            PdfStandard::A_3b => pdf::PdfStandard::A_3b,
            PdfStandard::A_3u => pdf::PdfStandard::A_3u,
            PdfStandard::A_3a => pdf::PdfStandard::A_3a,
            PdfStandard::A_4 => pdf::PdfStandard::A_4,
            PdfStandard::A_4f => pdf::PdfStandard::A_4f,
            PdfStandard::A_4e => pdf::PdfStandard::A_4e,
            PdfStandard::UA_1 => pdf::PdfStandard::Ua_1,
        }
    }
}
