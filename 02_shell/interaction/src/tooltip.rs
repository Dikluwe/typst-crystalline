...
use fusion::AsDocument;
use fusion::engine::Sink;
use fusion::foundations::{Binding, Capturer, CastInfo, Repr, Value, repr};
use fusion::layout::Length;
use fusion::syntax::ast::AstNode;
use fusion::syntax::{LinkedNode, Side, Source, SyntaxKind, ast};
use fusion::utils::{Numeric, round_with_precision};
use semantics::CapturesVisitor;
...
mod tests {
    ...
    fn test(world: impl WorldLike, pos: impl FilePos, side: Side) -> Response {
        ...
        let doc = fusion::compile::<PagedDocument>(world).output.ok();
