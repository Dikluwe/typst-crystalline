...
use fusion::foundations::{Label, Selector, Value};
use fusion::syntax::{LinkedNode, Side, Source, Span, ast};
use fusion::utils::PicoStr;
...
mod tests {
    ...
    use fusion::WorldExt;
    use fusion::foundations::{IntoValue, NativeElement};
    ...
    fn test_definition_std() {
        test("#table", 1, Side::After).must_be_value(fusion::model::TableElem::ELEM);
    }
}
