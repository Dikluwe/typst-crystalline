...
use primitives::foundations::{Content, Fold, Packed, Smart, StyleChain};
...
use primitives::model::{TableCell, TableChild, TableElem, TableItem};
use primitives::text::TextElem;
use primitives::visualize::{Paint, Stroke};

use lexicon::Span;
use shared::{NonZeroExt, SmallBitSet};
