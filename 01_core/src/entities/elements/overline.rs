...
mod tests {
    ...
    fn ex() -> OverlineElem {
        OverlineElem { body: Content::text("abc"), stroke: None, offset: None, extent: None }
    }
    ...
    fn is_empty_delega_ao_body() {
        assert!(!ex().is_empty());
        let vazio = OverlineElem { body: Content::Empty, stroke: None, offset: None, extent: None };
