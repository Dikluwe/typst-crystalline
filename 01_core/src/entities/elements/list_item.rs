...
mod tests {
    ...
    fn plain_text_com_bullet_default() {
        let li = ListItemElem { body: Content::text("um"), marker: None, marker_align: None };
    ...
    fn igualdade_estrutural() {
        let a = ListItemElem { body: Content::text("x"), marker: None, marker_align: None };
        assert_eq!(a.clone(), a.clone());
        assert_ne!(a, ListItemElem { body: Content::text("y"), marker: None, marker_align: None });
        assert_ne!(
            a,
            ListItemElem { body: Content::text("x"), marker: Some(ListMarker::Custom("→".into())), marker_align: None }
        );
    }
