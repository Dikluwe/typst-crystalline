//! Crystalline Lineage
//! @prompt 00_nucleo/prompts/entities/elements/grid_cell.md
//! @prompt-hash d0d1b27c
//! @layer L1
//! @updated 2026-06-11
//!
//! `GridCellElem` — Lote 12 P327 (bloco grid/table cell). `grid_cell(body, …)`.
...
/// Célula de `Grid`. `body` + 9 cosméticos (posição/span/estilo).
...
impl std::hash::Hash for GridCellElem {
...
impl Element for GridCellElem {
    ...
    {
        Ok(Content::GridCell(Arc::new(GridCellElem {
    ...
    where
        F: FnMut(&str) -> String,
    {
        Content::GridCell(Arc::new(GridCellElem {
...
mod tests {
    ...
    fn ex() -> GridCellElem {
        GridCellElem {
            body: Content::text("a"), x: None, y: None, colspan: None, rowspan: None,
            stroke: None, fill: None, align: None, inset: None, breakable: None,
        }
    }
