//! Crystalline Lineage
//! @prompt 00_nucleo/prompts/compiler/eval/markup.md
//! @prompt-hash b0e885ca
//! @layer L1
//! @updated 2026-04-23
//!
...
pub(super) fn eval_heading(
    ...
    // (§3a.8), que embrulha a cauda do markup onde este heading nasce. O
    // consumidor (layout/introspect) lê o gate da chain. Fonte única.
