...
use crate::compiler::introspect::extract_payload::extract_payload as do_extract_payload;
...
fn classify_unreferencable_body(content: &Content) -> UnreferencableKind {
    match content {
        ...
        // intencional: todo outro elemento não-Raw e não-Equation sem numeração é classificado como Text para mensagens de erro
        Content::Empty
        | Content::Text(_)
        | Content::Space
        | Content::Parbreak
