//! Crystalline Lineage
//! @prompt 00_nucleo/prompts/compiler/parse/math.md
//! @prompt-hash f634e022
//! @layer L1
//! @updated 2026-04-23
//!
...
fn math_op(
    ...
    let op = match kind {
        ...
        _ => return None, // neutro: N16[β] — tokens não-identificador retornam None no parse de math args
    };
    Some(op)
}
