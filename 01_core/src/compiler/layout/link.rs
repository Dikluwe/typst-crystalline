//! Crystalline Lineage
//! @prompt 00_nucleo/prompts/compiler/layout/link.md
//! @prompt-hash a56b2650
//! @layer L1
//! @updated 2026-06-23
//!
    ...
    for item in items {
        match item {
            FrameItem::Text { pos, text, style } => {
                ...
                let (_, line_h) = metrics.vertical_metrics(style.size, style);
...
mod tests {
    use super::*;
    use crate::compiler::layout::{FixedMetrics, Layouter};
