...
pub fn eval_with_full_error(
    ...
    let mut run_pass = |apply_show_rules: bool,
     ...
     -> SourceResult<(
        ...
        for (name, value) in crate::engine::stdlib::predefined_color_bindings() {
...
mod tests;
#[cfg(test)]
pub(crate) use crate::engine::eval::tests::eval_for_test;
// Re-export para o módulo de tests (que usa `use super::*;`).
#[cfg(test)]
pub(crate) use crate::engine::eval::operators::{eval_binary_op, eval_unary_op};
