...
mod tests {
    ...
    use crate::engine::layout::{layout, layout_with_introspector};
...
= H1"#,
    ...
    fn p498_d3c_residual_heading_query_pos_show_rule() {
        ...
        let intr = crate::engine::introspect::introspect_with_introspector(intr_content);
    ...
    // `Content::ContextBlock`, ver `engine/layout/mod.rs:1645`). Os testes
    ...
    fn p728_join_unitario() {
        use crate::engine::eval::operators::join;
        assert_eq!(
