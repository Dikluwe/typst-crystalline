...
/// (o conteúdo é descartado). Ver `00_nucleo/prompts/engine/eval.md` §P679.
fn eval_imported_file(
    ...
    for (n, value) in crate::engine::stdlib::predefined_color_bindings() {
        global.define(n.as_str(), value);
    }
    global.define(
        "text",
        Value::Func(Func::native("text", crate::engine::stdlib::native_text)),
    );
