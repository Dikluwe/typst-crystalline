...
use primitives::foundations::{Packed, Smart, StyleChain};
use primitives::introspection::{Introspector, Locator, LocatorLink, SplitLocator};
use primitives::layout::{Abs, AlignElem, Dir, FixedAlignment, Fragment, Size};
...
use primitives::routines::{Arenas, Pair, RealizationKind, Routines};
use primitives::text::{Costs, Lang, TextElem};
use ::shared::{Numeric, Protected, SliceExt};
