use primitives::diag::{SourceResult, bail, warning};
use primitives::foundations::{Content, Packed, Resolve, StyleChain, SymbolElem};
use primitives::layout::{
    Abs, Axes, Em, FixedAlignment, Frame, FrameItem, Point, Ratio, Rel, Size,
};
use primitives::math::{Augment, AugmentOffsets, CasesElem, MatElem, VecElem};
use primitives::text::TextElem;
use primitives::visualize::{FillRule, FixedStroke, Geometry, LineCap, Shape};
use lexicon::Span;
