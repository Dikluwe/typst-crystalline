...
use primitives::diag::warning;
use primitives::foundations::StyleChain;
use primitives::introspection::Tag;
use primitives::layout::{
    Abs, Axes, Axis, Corner, Em, Frame, FrameItem, Point, Size, VAlignment,
};
use primitives::math::{EquationElem, MathSize};
use primitives::text::{Font, TextElem, features, language, variant};
use primitives::visualize::Paint;
use lexicon::Span;
use ::shared::{Get, default_math_class};
