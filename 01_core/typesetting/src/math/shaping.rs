...
use primitives::layout::{Abs, Em};
use primitives::text::{Font, FontFamily, FontVariant, Glyph, Lang, Region, TextItem};
use primitives::visualize::{FixedStroke, Paint};
use lexicon::Span;
...
/// [`TextItem`](primitives::text::TextItem), the difference being the
