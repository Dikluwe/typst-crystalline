...
use primitives::foundations::{AlternativeFold, Fold};
use primitives::layout::Abs;
use primitives::layout::grid::resolve::{CellGrid, Line, Repeatable};
...
mod test {
    ...
    use primitives::layout::grid::resolve::{Cell, Entry, LinePosition};
    use primitives::layout::{Axes, Sides, Sizing};
